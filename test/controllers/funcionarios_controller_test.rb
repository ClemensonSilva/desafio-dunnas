...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference("Funcionario.count") do
      post funcionarios_url, params: { funcionario: { nome: @funcionario.nome, setor_id: @funcionario.setor_id, unidade_id: @funcionario.unidade_id } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { nome: @funcionario.nome, setor_id: @funcionario.setor_id, unidade_id: @funcionario.unidade_id } }
